...
{
    public class DefaultMonkeyObservableCollection: ObservableCollection<Monkey>
    {
        public DefaultMonkeyObservableCollection()
        {
            AddDefaultItems();
        }
        ...
        private void AddDefaultItems()
        {
            ...
            //Monkeys = new ObservableCollection<Monkey>(this);
